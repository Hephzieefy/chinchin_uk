const FIELD_CLASSES =
  "w-full min-h-[90px] resize-y rounded-[10px] border-[1.5px] border-line bg-white px-3.5 py-3 font-body text-[0.95rem] text-ink focus:border-gold-500 focus:outline-none";
